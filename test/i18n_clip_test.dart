...
void main() {
  ...
  // 급)이고 실기기(SM G950N)는 411 이다. **둘은 다른 질문이다** — 320 에서만 나는
  // 잘림은 「가장 좁은 기기에서 이렇게 된다」이고, 411 에서도 나면 「지금 사장님
  // 폰에서 이렇게 보인다」이다.
    ...
    for (final locale in locales) {
      for (final entry in screens.entries) {
        ...
        for (final el in tester.elementList(find.byType(Text))) {
          ...
          //   2026-09-22 전수감사에서 411dp·배율 1.1 기준 195건이 나왔는데, 그
          //   대부분은 「넘치지 말고 잘려라」로 일부러 그렇게 만든 자리다(버튼
          //   라벨 78 · 표 컬럼 헤더 79 · 지표 이름 20 · 화면 제목 10). 고치려면
          //   버튼·표의 높이 정책을 바꿔야 해서 **디자인 결정이 선행**한다.
